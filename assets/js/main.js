$(document).ready(function () {
    ...
    s1_tl
        .fromTo('._m .s1 h2 small', { y: '-100', opacity: 0 }, { y: '0', opacity: 1 })
        .fromTo('._m .s1 h2 .img-box', { y: '-100', opacity: 0 }, { y: '0', opacity: 1 });

    function section01and02() {
        // 섹션2 -------------------------------------
        let s2_tl = gsap.timeline();
        s2_tl
            .fromTo('._m .s2 .img-box', { y: 100, opacity: 0 }, { y: 0, opacity: 1, duration: 1 })
            .fromTo('._m .s2 .txt-box strong', { y: 100, opacity: 0 }, { y: 0, opacity: 1, duration: 1 }, '-=50%')
            .fromTo('._m .s2 .txt-box small', { y: 100, opacity: 0 }, { y: 0, opacity: 1, duration: 1 }, '-=50%');
    ...
    let s4_txt_stroke = document.querySelector('._m .s4 .visual .section-title.n2');
    ...
    function section04() {
        ScrollTrigger.matchMedia({
            ...
            '(min-width: 821px)': function () {
                ...
                s4_tl
                    .fromTo('._m .s4 .visual .img-area', { width: '100%' }, { width: '46%' })
